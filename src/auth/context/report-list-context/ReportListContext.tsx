...
interface ReportListContextProps {
    ...
    createReport: (residenceId: any, bookingId: any, reportType: any, severity: any, title: any, description: any) => Promise<void>
}
...
export const ReportListProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const createReport = async (residenceId: any, bookingId: any, reportType: any, severity: any, title: any, description: any) => {
        try {
            setIsLoading(true);
            await axiosInstance.post(`${baseUrl}`, { residenceId, bookingId, reportType, severity, title, description });
