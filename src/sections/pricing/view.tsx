...
import SellerPackageCard from 'src/components/swiper/seller-card-swipper';
import HostPackageCard from 'src/components/swiper/host-card-swpiper';
...
export default function PricingView() {
  return (
    ...
    >
      ...
      Gói linh hoạt theo quy mô và nhu cầu
        <br /> {`của cộng đồng bạn`}
      </Typography>

      <Typography align="center" sx={{ color: 'text.secondary' }}>
      Chọn kế hoạch của bạn và thực hiện quản lý hiện đại
      </Typography>
      ...
      <Box sx={{mt:5}}>
        <Grid container spacing={15} columns={16}>
          <Grid item xs={8}>
            <Typography sx={{py:2}}>Package for seller:</Typography>
            <SellerPackageCard />
          </Grid>
          <Grid item xs={8}>
          <Typography sx={{py:2}}>Package for host:</Typography>
