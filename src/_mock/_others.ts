...
export const _carouselsMembers = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
...
const des =[{
  question:'Hosite là gì ?',
  detail :' Hosite là một ứng dụng được thiết kế dành riêng cho host và seller.'
},{
  question:'Hosite  có thể giúp gì?',
  detail :' Hosite giúp tiết kiệm thời gian  cho chủ nhà  cũng như tạo điều kiện tăng thu nhập cho seller.'
},{
  question:'Ưu điểm của hostie',
  detail :'Hostie được thiết kế với giao diện thân thiện và dễ dàng sử dụng.'
},{
  question:'Chính sách của hostie',
  detail :'Với chính sách kết nối chủ nhà và seller .Hostie luôn  quan tâm  và muốn mở rộng  cộng đồng sử dụng'
},{
  question:'Làm thế nào để tạo tài khoản?',
  detail :'Người dùng có thể tạo tài khoản bằng cách nhấn vào nút "Đăng ký" trên trang chính và điền đầy đủ thông tin yêu cầu.Bạn có thể đăng ký với vai trò quản gia hoặc seller/host nhưng bắt buộc phải có mã giới thiệu '
},{
  question:'Làm sao để liên hệ hỗ trợ?',
  detail :'Nếu bạn gặp bất kỳ vấn đề gì, vui lòng liên hệ với chúng tôi qua email. Đội ngũ hỗ trợ luôn sẵn sàng giúp đỡ'
},
{
  question:'Tôi có thể sử dụng ứng dụng trên thiết bị nào??',
  detail :'Ứng dụng hỗ trợ trên các trình duyệt web phổ biến như Chrome, Firefox, Safari. Ngoài ra, chúng tôi cũng có phiên bản dành cho iOS và Android .'
},
{
  question:'Tại sao tôi không nhận được email xác nhận?',
  detail :'Hãy kiểm tra hộp thư rác (Spam). Nếu không thấy, vui lòng thử lại hoặc liên hệ bộ phận hỗ trợ để được trợ giúp.'
}]

export const _faqs = [...Array(8)].map((_, index) => ({
  id: _mock.id(index),
  value: `panel${index + 1}`,
  heading: `Câu hỏi ${index + 1} : ${des[index]?.question}`,
  detail: des[index]?.detail, // faq
}));
